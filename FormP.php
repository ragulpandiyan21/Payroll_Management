...
session_start();
    ...
    $sql="SELECT empid,adv FROM emp_salary WHERE salmonth = ? AND salyear = ?;";
    ...
    class PDF extends FPDF {
        ...
        function Header() {
            ...
            // Header
            $this->Cell(70,12,'AHMED BROS  FORM P',0,0,'C');
    ...
    $pdf->Cell(35,10,'Month',1,0,'C');
    $pdf->Cell(35,10,'Advance',1,0,'C');
    $pdf->Ln(11);
    foreach ($resultData as $row){
        ...
        $pdf->Cell(35,10,$mnth.'',1,0);
        $pdf->Cell(35,10,$row['adv'].'',1,0);
        $pdf->Ln(9.8);
    }
    $pdf->Output();
?>